...
namespace Athletes_Info
{
    public partial class Local : Form
    {
        ...
        private void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            string Query = "Insert into International(idnum,Imonth,Icompetition,Irank,Iproof) values ('" + this.lbl_id.Text + "','" + this.tbMonth.Text + "', '" + this.tbCompetition.Text + "', '" + this.tbRank.Text + "', '" + this.pbLocal.Image + "');";
